**02_SQL_ETL_Workflows — Extract Scripts**
...
The SQL below is the cleaned and formatted extract script. The headings above are bold so they render on GitHub README pages while the SQL is shown in a fenced code block.
